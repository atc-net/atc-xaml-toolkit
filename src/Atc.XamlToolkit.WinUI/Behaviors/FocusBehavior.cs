...
/// <summary>
/// A behavior that manages focus for UI elements in WinUI applications.
/// Allows declarative focus control through XAML properties.
/// </summary>
public sealed class FocusBehavior : Microsoft.Xaml.Interactivity.Behavior<FrameworkElement>
{
    /// <summary>
    ...
    private void OnGotFocus(object sender, RoutedEventArgs e)
    {
        ...
        if (SelectAllOnFocus && AssociatedObject is Microsoft.UI.Xaml.Controls.TextBox textBox)
        {
            textBox.SelectAll();
        }
    }
