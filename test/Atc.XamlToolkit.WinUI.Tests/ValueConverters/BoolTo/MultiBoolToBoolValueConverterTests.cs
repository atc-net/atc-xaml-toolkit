...
{
    private readonly MultiBoolToBoolValueConverter converter = MultiBoolToBoolValueConverter.Instance;
        ...
        string inputSetName)
    {
        ...
        // Act
        var actual = converter.Convert(input, parameter: null, culture: CultureInfo.InvariantCulture);
    ...
    {
        // Act
        var exception = Record.Exception(() => converter.ConvertBack(value: false, parameter: null, culture: null));
