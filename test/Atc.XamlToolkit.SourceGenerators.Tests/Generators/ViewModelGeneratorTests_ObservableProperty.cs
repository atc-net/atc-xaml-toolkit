...
{
    [Fact]
    public void ObservableProperty_OnReadonlyField_GeneratesGetOnlyProperty()
    {
        // The generator inspects fieldSymbol.IsReadOnly and short-circuits the
        // setter — the resulting property is get-only, no PropertyChanged
        // wiring (you can't change it). Pin the shape so future refactors
        // don't accidentally start emitting a setter that would fail to
        // compile against the readonly backing field.
    ...
    [Fact]
    public void ObservableProperty_OnReadonlyField_WithGeneratePartialHooks_DoesNotEmitHooks()
    {
        // Partial hooks are setter-side concerns — they can't run if there's
        // no setter. The builder guards with `!p.IsReadOnly` for exactly this
        // reason. Pin the no-hooks behaviour.
        const string inputCode =
            """
            namespace TestNamespace;
    ...
    [Fact]
    public void ObservableProperty_NotifyCanExecuteChangedFor_SingleCommand()
    {
        const string inputCode =
            """
            namespace TestNamespace;
    ...
    [Fact]
    public void ObservableProperty_NotifyCanExecuteChangedFor_MultipleCommands()
    {
        const string inputCode =
            """
            namespace TestNamespace;
            ...
            {
                [ObservableProperty]
                [NotifyCanExecuteChangedFor(nameof(SaveCommand), nameof(SubmitCommand))]
                private string firstName = "John";
            }
            """;
    ...
    [Fact]
    public void ObservableProperty_NotifyCanExecuteChangedFor_MergesWith_DependentCommandNames()
    {
        const string inputCode =
            """
            namespace TestNamespace;
    ...
    [Fact]
    public void ObservableProperty_GenericList_FieldType()
    {
        const string inputCode =
            """
            namespace TestNamespace;
    ...
    [Fact]
    public void ObservableProperty_NestedGeneric_FieldType()
    {
        const string inputCode =
            """
            namespace TestNamespace;
            ...
            {
                [ObservableProperty]
                private Dictionary<string, List<int>> grouped;
            }
            """;
        ...
        const string expectedCode =
            ...
            public partial class TestViewModel
            {
                public Dictionary<string, List<int>> Grouped
                {
                    get => grouped;
                    set
                    {
                        ...
                        grouped = value;
                        RaisePropertyChanged(nameof(Grouped));
                    }
                }
            }
    ...
    [Fact]
    public void ObservableProperty_NullableGeneric_FieldType()
    {
        const string inputCode =
            """
            namespace TestNamespace;
            ...
            public partial class TestViewModel
            {
                public List<int>? MaybeItems
                {
                    ...
                    set
                    {
                        ...
                        maybeItems = value;
                        RaisePropertyChanged(nameof(MaybeItems));
                    }
                }
            }
    ...
    [Fact]
    public void ObservableProperty_OnPrimaryConstructorClass()
    {
        const string inputCode =
            """
            namespace TestNamespace;

            public partial class TestViewModel(ILogger logger) : ViewModelBase
            {
