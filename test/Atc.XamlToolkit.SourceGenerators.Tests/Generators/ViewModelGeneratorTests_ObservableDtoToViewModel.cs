...
public sealed partial class ViewModelGeneratorTests
{
    ...
    [Fact]
    public void ObservableDtoViewModel_Class_Person_WithCustom_PropertyAndCommandAndComputedProperty()
    {
        const string inputCode =
            """
             namespace TestNamespace;
    ...
    [Fact]
    public void ObservableDtoViewModel_Class_Person_WithCustom_PropertyAndCommandAndComputedProperty_And_CodeDocumentation()
    {
        const string inputCode =
            """
             namespace TestNamespace;
             ...
             public class Person
             {
                 ...
                 /// </summary>
                 /// <remarks>The first name is great.</remarks>
                 [Required(ErrorMessage = "First name is required")]
                 [MinLength(2, ErrorMessage = "First name must be at least 2 characters long")]
                 [MaxLength(50, ErrorMessage = "First name cannot exceed 50 characters")]
                 public string? FirstName { get; set; }
                 ...
                 /// </summary>
                 /// <remarks>The last name is great.</remarks>
                 [Required(ErrorMessage = "Last name is required")]
                 [MinLength(2, ErrorMessage = "Last name must be at least 2 characters long")]
                 [MaxLength(50, ErrorMessage = "Last name cannot exceed 50 characters")]
                 public string? LastName { get; set; }
