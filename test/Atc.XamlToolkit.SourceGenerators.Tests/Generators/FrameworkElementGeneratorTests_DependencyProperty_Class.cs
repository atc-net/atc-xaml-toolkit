...
public sealed partial class FrameworkElementGeneratorTests
{
            ...
            public partial class MyControl
            {
                public static readonly DependencyProperty IsRunningProperty = DependencyProperty.Register(
                    ...
                    new FrameworkPropertyMetadata(
                        defaultValue: Atc.XamlToolkit.BooleanBoxes.TrueBox,
                        propertyChangedCallback: PropertyChangedCallback,
                        coerceValueCallback: CoerceValueCallback,
    ...
    [Fact]
    public void DependencyProperty_Class_UInt_Name()
    {
        const string inputCode =
            """
            namespace TestNamespace;

            [DependencyProperty<uint>("UIntValue")]
            public partial class MyControl : UserControl
            {
            }
            """;
    ...
    [Fact]
    public void DependencyProperty_Class_UInt_Name_DefaultValue()
    {
        const string inputCode =
            """
            namespace TestNamespace;

            [DependencyProperty<uint>("UIntValue", DefaultValue = 1U)]
            public partial class MyControl : UserControl
            {
            }
            """;
    ...
    [Fact]
    public void DependencyProperty_Class_Long_Name()
    {
        const string inputCode =
            """
            namespace TestNamespace;

            [DependencyProperty<long>("LongValue")]
            public partial class MyControl : UserControl
            {
            }
            """;
    ...
    [Fact]
    public void DependencyProperty_Class_ULong_Name()
    {
        const string inputCode =
            """
            namespace TestNamespace;

            [DependencyProperty<ulong>("UlongValue")]
            public partial class MyControl : UserControl
            {
            }
            """;
        ...
        const string expectedCode =
            ...
            public partial class MyControl
            {
                public static readonly DependencyProperty UlongValueProperty = DependencyProperty.Register(
                    ...
                    typeof(ulong),
                    typeof(MyControl),
                    new PropertyMetadata(defaultValue: 0UL));
