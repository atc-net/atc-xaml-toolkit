...
{
    [Fact]
    public void AttachedProperty_Class_Bool_Name()
    {
    ...
    [Fact]
    public void AttachedProperty_Class_Bool_Name_DefaultValue()
    {
        const string inputCode =
            """
            namespace TestNamespace;
        ...
        const string expectedCode =
            ...
            public static partial class DragBehavior
            {
                public static readonly DependencyProperty IsDraggableProperty = DependencyProperty.RegisterAttached(
                    ...
                    typeof(bool),
                    typeof(DragBehavior),
                    new PropertyMetadata(defaultValue: Atc.XamlToolkit.BooleanBoxes.TrueBox));
    ...
    [Fact]
    public void AttachedProperty_Class_Bool_Name_DefaultValue_Category()
    {
        const string inputCode =
            """
            namespace TestNamespace;
    ...
    [Fact]
    public void AttachedProperty_Class_Bool_Name_DefaultValue_Description()
    {
        const string inputCode =
            """
            namespace TestNamespace;
    ...
    [Fact]
    public void AttachedProperty_Class_Bool_Name_DefaultValue_Description_Category()
    {
        const string inputCode =
            """
            namespace TestNamespace;
    ...
    [Fact]
    public void AttachedProperty_Class_Bool_Name_PropertyChangedCallback()
    {
        const string inputCode =
            """
            namespace TestNamespace;
    ...
    [Fact]
    public void AttachedProperty_Class_WatermarkTextBoxBehavior()
    {
        const string inputCode =
            """
            namespace TestNamespace;
        ...
        const string expectedCode =
            ...
            public static partial class WatermarkTextBoxBehavior
            {
                ...
                public static void SetEnableWatermark(DependencyObject element, bool value)
                    => element?.SetValue(EnableWatermarkProperty, Atc.XamlToolkit.BooleanBoxes.Box(value));
            }
